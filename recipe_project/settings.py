...
ALLOWED_HOSTS = [
    ...
    'https://recipe-app-rach.onrender.com'
...
DATABASES = {
    'default': {
       ...
       # If you're using PostgreSQL (which is recommended for Render), 
       # you can use dj-database-url to simplify database configuration.
